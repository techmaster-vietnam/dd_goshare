...
type Payment struct {
	...
	TransactionID  *string        `gorm:"size:255" json:"transaction_id"`          // mỗi lần thanh toán riêng biệt
	ReceiptData    *string        `gorm:"type:text" json:"receipt_data"`           // base64 hoặc token
